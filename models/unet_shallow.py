...
def Unet_shallow(input_shape=(512, 512, 1), dropout_rate=0.1, l2_lambda=0.0, activation_function='relu'):
    inputs = Input(shape=input_shape)
    activation = activation_function

    # Contracting Path
    c1 = Conv2D(8, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c2 = Conv2D(16, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c3 = Conv2D(32, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c4 = Conv2D(64, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c8 = Conv2D(16, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c9 = Conv2D(8, (3, 3), activation=activation, kernel_initializer='he_normal', 
