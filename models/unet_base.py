...
def Unet(input_shape=(512, 512, 1), dropout_rate=0.1, l2_lambda=0.0, activation_function='relu'):
    activation = activation_function if activation_function == 'relu' else 'leaky_relu'
    
    inputs = Input(shape=input_shape)
    
    # Contracting Path
    c1 = Conv2D(16, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c2 = Conv2D(32, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c3 = Conv2D(64, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c4 = Conv2D(128, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c5 = Conv2D(256, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c6 = Conv2D(128, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c7 = Conv2D(64, (3, 3), activation=activation, kernel_initializer='he_normal', 
    ...
    c8 = Conv2D(32, (3, 3), activation=activation, kernel_initializer='he_normal', 
                padding='same', kernel_regularizer=l2(l2_lambda))(u8)
    c8 = Dropout(dropout_rate)(c8)
    c8 = Conv2D(32, (3, 3), activation=activation, kernel_initializer='he_normal', 
                padding='same', kernel_regularizer=l2(l2_lambda))(c8)

    u9 = Conv2DTranspose(16, (2, 2), strides=(2, 2), padding='same')(c8)
    u9 = concatenate([u9, c1])
    c9 = Conv2D(16, (3, 3), activation=activation, kernel_initializer='he_normal', 
                padding='same', kernel_regularizer=l2(l2_lambda))(u9)
    c9 = Dropout(dropout_rate)(c9)
    c9 = Conv2D(16, (3, 3), activation=activation, kernel_initializer='he_normal', 
                padding='same', kernel_regularizer=l2(l2_lambda))(c9)
