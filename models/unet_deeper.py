...
def Unet_deeper(input_shape=(512, 512, 1), dropout_rate=0.1, l2_lambda=0.001, activation_function='relu'):
    ...
    c6 = Conv2D(128, (3, 3), activation=activation, kernel_initializer='he_normal', padding='same',
    ...
    c7 = Conv2D(64, (3, 3), activation=activation, kernel_initializer='he_normal', padding='same',
    ...
    c8 = Conv2D(32, (3, 3), activation=activation, kernel_initializer='he_normal', padding='same',
    ...
    c9 = Conv2D(16, (3, 3), activation=activation, kernel_initializer='he_normal', padding='same',
